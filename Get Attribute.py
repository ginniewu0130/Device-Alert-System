...
with open('output_2.csv', 'w', newline='') as csvfile:
    ...
    writer.writerow(['Source IP','Destination IP', 'Source Port Number', 'Destination Port Number', 'Time', 'Type', 'Sub-Type', 'Action'])
    ...
    for log in logs:
        ...
        if match:
            ...
            logdesc = None
        writer.writerow([srcip, dstip , srcport, dstport,i, maintype,subtype,action])
        i += 1